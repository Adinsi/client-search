...
const Forgetpassword = () => {
                ...
                
 {
   ...
   Seterroremail('')
   if (error) return Seterroremail('Connexion Internet non active');
     Seterroremail('')
...
Vous rencontrez toujours des difficultés pour vous connecter ? Veuillez contacter l'assistance.
                     ...
                     <NavLink style={{textAlign:'right',margin:'15px',position:'relative',right:'-80px',top:'15px'}} to='/'>Revenir à l'accueil</NavLink>
